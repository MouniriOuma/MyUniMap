        ...
        >
            <View style={{ flex: 1 }}>
                <View>
                    ...
                    <Image
                        source={require('../../assets/studyGroup.jpg')}
                        style={{
                            width: 100,
                            height: 100,
                            borderRadius: 20,
                ...
                <View style={{
                    ...
                    <View style={{ marginVertical: 22 }}>
                        <Text style={{
                            ...
                            color: COLORS.white,
                            marginVertical: 4
                        }}>Let's get started and explore the features of our app together. </Text>
                        <Text style={{
                            fontSize: 16,
                            color: COLORS.white,
                        }}>This tutorial will guide you through everything.</Text>
                    </View>
